...
class SyncGoalsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'goals.*.notesList' => ['array'],
            'goals.*.notesList.*.id' => ['required', 'string'],
            'goals.*.notesList.*.title' => ['nullable', 'string'],
            'goals.*.notesList.*.body' => ['nullable', 'string'],
            'goals.*.notesList.*.images' => ['array'],
            'goals.*.notesList.*.images.*' => ['string'],
            'goals.*.notesList.*.createdAt' => ['nullable', 'string'],
            ...
            'goals.*.checklist.*.completionNote' => ['nullable', 'string'],
            'goals.*.checklist.*.completionImages' => ['array'],
            'goals.*.checklist.*.completionImages.*' => ['string'],
            'goals.*.checklist.*.notesList' => ['array'],
            'goals.*.checklist.*.notesList.*.id' => ['required', 'string'],
            'goals.*.checklist.*.notesList.*.title' => ['nullable', 'string'],
            'goals.*.checklist.*.notesList.*.body' => ['nullable', 'string'],
            'goals.*.checklist.*.notesList.*.images' => ['array'],
            'goals.*.checklist.*.notesList.*.images.*' => ['string'],
            'goals.*.checklist.*.notesList.*.createdAt' => ['nullable', 'string'],
